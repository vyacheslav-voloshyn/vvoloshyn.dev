...
export default function ContactPage() {
  return (
    <PageLayout
      title="Get in Touch"
      description="Have a project in mind or want to discuss a potential collaboration? I'd love to hear from you. Fill out the form and I'll get back to you as soon as possible."
    >
