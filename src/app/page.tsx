...
export default function Home() {
  return (
    <PageLayout
      ...
      description="I build exceptional digital experiences that combine creativity with technical expertise, focusing on clean code, intuitive interfaces, and scalable solutions."
    >
