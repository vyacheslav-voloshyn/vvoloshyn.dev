...
export default function Hero() {
  return (
    <section className="pb-16 pt-24 sm:pb-20 sm:pt-32 lg:pb-32 lg:pt-40">
      <div className="content-box bg-white dark:bg-gray-900">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="space-y-6">
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              <span className="heading-gradient">Vyacheslav</span> Voloshyn
            </h1>
          ...
          <div className="relative mx-auto aspect-square w-full max-w-md overflow-hidden rounded-2xl border border-gray-200 shadow-lg dark:border-gray-800 lg:mx-0 lg:max-w-none">
            <Image
              src="/profile.jpg"
